...
export default function PrivacyPolicyPage() {
  return (
    <div className="content-page">
      ...
      <p>When you use our services, you may provide us with the following types of information:</p>
      <ul>
        <li><strong>Account Information:</strong> When you create an account using third-party authentication (such as GitHub or Google), we receive your name, email address, and profile picture from the authentication provider.</li>
        <li><strong>Resume Data:</strong> The content you enter into our resume builder, including your name, contact information, work history, education, and skills. This data is stored securely in our database so you can access it across sessions.</li>
      ...
      <ul>
        ...
        <li><strong>IP Address:</strong> Your Internet Protocol address, which may be used to estimate your general geographic location.</li>
        <li><strong>Cookies and Similar Technologies:</strong> We use cookies, web beacons, and similar tracking technologies to collect information about your browsing activity. See Section 4 for more details.</li>
      </ul>
      ...
      <ul>
        ...
        <li>To save and retrieve your resume data across sessions when you are signed in.</li>
        <li>To respond to your inquiries and provide customer support.</li>
        <li>To send you important updates about our service (we do not send marketing emails without your consent).</li>
      ...
      <p>
        We use Google AdSense, a third-party advertising service provided by Google LLC, to display 
        advertisements on our website. Google AdSense may use cookies and similar technologies to serve 
      ...
      <p>
        ...
        visiting <a href="https://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer">www.aboutads.info/choices</a>.
      </p>

      <h2>4. Cookies and Tracking Technologies</h2>
      <p>We use the following types of cookies:</p>
      <ul>
        <li><strong>Essential Cookies:</strong> Required for the basic functionality of our website, such as maintaining your session and remembering your cookie consent preferences.</li>
        ...
        <li><strong>Advertising Cookies:</strong> Used by our advertising partners (including Google AdSense) to deliver relevant advertisements and track ad campaign performance.</li>
      </ul>
      <p>
      ...
      <ul>
        <li><strong>Service Providers:</strong> We share data with trusted service providers who help us operate our website, such as our hosting provider (Vercel) and database provider (Neon). These providers are contractually obligated to protect your data.</li>
        <li><strong>Authentication Providers:</strong> When you sign in using a third-party service (e.g., GitHub), your authentication data is processed by that provider according to their privacy policy.</li>
      ...
      <p>
        ...
        encryption of data in transit (TLS/SSL), secure database storage, and regular security reviews.
      </p>
      <p>
      ...
      <p>
        ...
        changes by posting a notice on our website. Your continued use of our service after changes 
